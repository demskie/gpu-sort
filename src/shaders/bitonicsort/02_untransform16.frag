...
void main() {
	...
	float firstSignBitIsSet = floatGreaterThanOrEqual(texel.g, 128.0);
	float secondSignBitIsSet = floatGreaterThanOrEqual(texel.a, 128.0);
	...
	flipped.r += floatEquals(u_mode, FLOAT) * floatEquals(firstSignBitIsSet, 1.0) * texel.r
			   + floatEquals(u_mode, FLOAT) * floatEquals(firstSignBitIsSet, 0.0) * (255.0 - texel.r);
	flipped.g += floatEquals(u_mode, FLOAT) * floatEquals(firstSignBitIsSet, 1.0) * (texel.g - 128.0)
			   + floatEquals(u_mode, FLOAT) * floatEquals(firstSignBitIsSet, 0.0) * (255.0 - texel.g);
	flipped.b += floatEquals(u_mode, FLOAT) * floatEquals(secondSignBitIsSet, 1.0) * texel.b
			   + floatEquals(u_mode, FLOAT) * floatEquals(secondSignBitIsSet, 0.0) * (255.0 - texel.b);
	flipped.a += floatEquals(u_mode, FLOAT) * floatEquals(secondSignBitIsSet, 1.0) * (texel.a - 128.0)
			   + floatEquals(u_mode, FLOAT) * floatEquals(secondSignBitIsSet, 0.0) * (255.0 - texel.a);
