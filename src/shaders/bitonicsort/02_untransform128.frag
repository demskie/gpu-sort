...
void main() {
	...
	float signBitIsSet = floatGreaterThanOrEqual(texelFour.a, 128.0);
	...
	flippedTwo.a   += floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 1.0) * texelTwo.b
			        + floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 0.0) * (255.0 - texelTwo.b);
	flippedThree.r += floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 1.0) * texelThree.r
				    + floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 0.0) * (255.0 - texelThree.r);
	flippedThree.g += floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 1.0) * texelThree.g
			        + floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 0.0) * (255.0 - texelThree.g);
	flippedThree.b += floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 1.0) * texelThree.b
			        + floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 0.0) * (255.0 - texelThree.b);
	flippedThree.a += floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 1.0) * texelThree.b
			        + floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 0.0) * (255.0 - texelThree.b);
	flippedFour.r  += floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 1.0) * texelFour.r
				    + floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 0.0) * (255.0 - texelFour.r);
	flippedFour.g  += floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 1.0) * texelFour.g
			        + floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 0.0) * (255.0 - texelFour.g);
	flippedFour.b  += floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 1.0) * texelFour.b
			        + floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 0.0) * (255.0 - texelFour.b);
	flippedFour.a  += floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 1.0) * (texelFour.a - 128.0)
			        + floatEquals(u_mode, FLOAT) * floatEquals(signBitIsSet, 0.0) * (255.0 - texelFour.a);
