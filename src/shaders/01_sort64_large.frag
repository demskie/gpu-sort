...
void main() {
	...
	vec4 peerDataOne = texture2D(u_firstBytes,   vec2(peerFragCoord.x + 0.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(firstTextureBool, 1.0)
					 ...
					 + texture2D(u_fifthBytes,   vec2(peerFragCoord.x + 0.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(fifthTextureBool, 1.0)
                	 + texture2D(u_sixthBytes,   vec2(peerFragCoord.x + 0.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(sixthTextureBool, 1.0)
                     + texture2D(u_seventhBytes, vec2(peerFragCoord.x + 0.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(seventhTextureBool, 1.0)
                     + texture2D(u_eighthBytes,  vec2(peerFragCoord.x + 0.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(eighthTextureBool, 1.0);
	vec4 peerDataTwo = texture2D(u_firstBytes,   vec2(peerFragCoord.x + 1.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(firstTextureBool, 1.0)
					 ...
					 + texture2D(u_fifthBytes,   vec2(peerFragCoord.x + 1.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(fifthTextureBool, 1.0)
                	 + texture2D(u_sixthBytes,   vec2(peerFragCoord.x + 1.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(sixthTextureBool, 1.0)
                     + texture2D(u_seventhBytes, vec2(peerFragCoord.x + 1.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(seventhTextureBool, 1.0)
                     + texture2D(u_eighthBytes,  vec2(peerFragCoord.x + 1.5, mod(peerFragCoord.y, u_width)) / u_width) * floatEquals(eighthTextureBool, 1.0);
