...
export function sort(
  ...
  switch (Object.prototype.toString.call(array)) {
    case "[object Int8Array]":
      return (array as Int8Array).sort((a: number, b: number) => a - b);
    case "[object Uint8Array]":
      return (array as Uint8Array).sort((a: number, b: number) => a - b);
    case "[object Uint8ClampedArray]":
      return (array as Uint8ClampedArray).sort((a: number, b: number) => a - b);
    case "[object Int16Array]":
      return (array as Int16Array).sort((a: number, b: number) => a - b);
    case "[object Uint16Array]":
      return (array as Uint16Array).sort((a: number, b: number) => a - b);
