...
export function sortInt16Array(array: Int16Array) {
  if (!array.constructor.name || array.constructor.name === "Int16Array") return bitonicSort(array);
...
export function sortUint16Array(array: Uint16Array) {
  if (!array.constructor.name || array.constructor.name === "Uint16Array") return bitonicSort(array);
...
export function sortInt32Array(array: Int16Array) {
  if (!array.constructor.name || array.constructor.name === "Int32Array") return bitonicSort(array);
...
export function sortUint32Array(array: Uint32Array) {
  if (!array.constructor.name || array.constructor.name === "Uint32Array") return bitonicSort(array);
...
export function sortFloat32Array(array: Float32Array) {
  if (!array.constructor.name || array.constructor.name === "Float32Array") return bitonicSort(array);
...
export function sortFloat64Array(array: Float64Array) {
  if (!array.constructor.name || array.constructor.name === "Float64Array") return bitonicSort(array);
...
export function sortBigInt64Array(array: BigInt64Array) {
  if (!array.constructor.name || array.constructor.name === "BigInt64Array") return bitonicSort(array);
...
export function sortBigUint64Array(array: BigUint64Array) {
  if (!array.constructor.name || array.constructor.name === "BigUint64Array") return bitonicSort(array);
