...
export function sortInt32ArrayAsync(array: Int32Array, fps?: number) {
  if (checkConstructor(array, "Int32Array")) return bitonicSort(array, "Int32Array", fps ? fps : 60);
  throw new Error(`array parameter of '${array.constructor.name}' was not a Int32Array`);
}
...
export function sortUint32ArrayAsync(array: Uint32Array, fps?: number) {
  if (checkConstructor(array, "Uint32Array")) return bitonicSort(array, "Uint32Array", fps ? fps : 60);
  throw new Error(`array parameter of '${array.constructor.name}' was not a Uint32Array`);
}
...
export function sortFloat32ArrayAsync(array: Float32Array, fps?: number) {
  if (checkConstructor(array, "Float32Array")) return bitonicSort(array, "Float32Array", fps ? fps : 60);
  throw new Error(`array parameter of '${array.constructor.name}' was not a Float32Array`);
}
...
export function sortFloat64ArrayAsync(array: Float64Array, fps?: number) {
  if (checkConstructor(array, "Float64Array")) return bitonicSort(array, "Float64Array", fps ? fps : 60);
  throw new Error(`array parameter of '${array.constructor.name}' was not a Float64Array`);
}
...
export function sortBigInt64ArrayAsync(array: BigInt64Array, fps?: number) {
  if (checkConstructor(array, "BigInt64Array")) return bitonicSort(array, "BigInt64Array", fps ? fps : 60);
  throw new Error(`array parameter of '${array.constructor.name}' was not a BigInt64Array`);
}
...
export function sortBigUint64ArrayAsync(array: BigUint64Array, fps?: number) {
  if (checkConstructor(array, "BigUint64Array")) return bitonicSort(array, "BigUint64Array", fps ? fps : 60);
  throw new Error(`array parameter of '${array.constructor.name}' was not a BigUint64Array`);
}
